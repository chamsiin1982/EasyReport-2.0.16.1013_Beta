...
var DesignerMVC = {
    ...
    View: {
        ...
        initSqlEditorOrder: function () {
            var dom = document.getElementById("report-sqlOrder");
            DesignerMVC.View.SqlEditorOrder = CodeMirror.fromTextArea(dom, {
                mode: 'text/x-mysql',
                theme: 'rubyblue',
                indentWithTabs: true,
                smartIndent: true,
            ...
            DesignerMVC.View.SqlEditorOrder.on("change", function (cm, obj) {
                if (obj.origin == "setValue") {
                    $('#report-sqlOrderIsChange').val(0);
                } else {
                    $('#report-sqlOrderIsChange').val(1);
                }
            });
        },
        
        
        initSqlEditorParam: function () {
            var dom = document.getElementById("report-sqlParam");
            DesignerMVC.View.SqlEditorParam = CodeMirror.fromTextArea(dom, {
                mode: 'text/x-mysql',
                theme: 'rubyblue',
                indentWithTabs: true,
                smartIndent: true,
            ...
            DesignerMVC.View.SqlEditorParam.on("change", function (cm, obj) {
                if (obj.origin == "setValue") {
                    $('#report-sqlParamIsChange').val(0);
                } else {
                    $('#report-sqlParamIsChange').val(1);
                }
            });
        },
    ...
    Util: {
        ...
        resizeDesignerDlgElments: function () {
           ...
           // $('#report-sqlParam-td>.CodeMirror').css({"width": panelOptions.width - 250});
           // $('#report-sqlOrder-td>.CodeMirror').css({"width": panelOptions.width - 250});
