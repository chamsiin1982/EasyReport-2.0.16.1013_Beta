...
public interface ITableReportService {
    ...
    ReportTable getReportTable(int id, Map<String, Object> formParams,Map<String, Object> appendParams);

    ReportTable getReportTable(String uid, Map<String, Object> formParams,Map<String, Object> appendParams);

    ReportTable getReportTable(Report report, Map<String, Object> formParams,Map<String, Object> appendParams);
    ...
    ReportDataSet getReportDataSet(Report report, Map<String, Object> parameters,Map<String, Object> appendParams);
