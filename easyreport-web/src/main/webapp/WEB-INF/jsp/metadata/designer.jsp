                ...
                <form id="report-basic-conf-form" name="report-basic-conf-form" method="post">
                    <table class="designer-table" style="width: 95%">
                        ...
                        <!-- 
                         <tr>
                            <td>SQL条件区:</td>
                            <td colspan="7"  id="report-sqlParam-td"> 
                            	<textarea id="report-sqlParam" name="sqlParam"></textarea>
                            	<input type="hidden" id="report-sqlParamIsChange" name="sqlParamIsChange" value="0"/>
                            </td>                           
                         </tr>
                        <tr>
                            <td>SQL排序区:</td>
                            <td colspan="7" id="report-sqlOrder-td"> 
                            	<textarea id="report-sqlOrder" name="sqlOrder"></textarea>
                            	<input type="hidden" id="report-sqlOrderIsChange" name="sqlOrderIsChange" value="0"/>
                            </td>                           
                         </tr>
                          -->
                        <tr>
                ...
                <form id="report-query-param-form" method="post">
                    <table class="designer-table">
                      <tr style="color:blue;">
                        	<td>变量类型:</td>
                            <td>
                            	<select class="easyui-combobox" id="report-query-param-append-type"
                                                    name="appendType" data-options="required:true" style="width:150px">
                        	...
                        	<td>附加类型:</td>
                        	<td>
	                        	<select class="easyui-combobox" id="report-query-param-is-and-or" name="isAndOr" data-options="required:true" style="width:150px">
	                                	<option value="and">and</option>
	                                	<option value="or">or</option>
	                            	</select>
                        	</td>
                        	<td>SQL列:</td>
                        	<td><input class="easyui-textbox" type="text" id="report-query-param-column-name" name="columnName"
                                       value="column name"  style="width:150px"/></td>
                                       <td>操作符:</td>
                                       <td><select class="easyui-combobox" id="report-query-param-operator"
	                                                    name="operator" data-options="required:true" style="width:150px">
