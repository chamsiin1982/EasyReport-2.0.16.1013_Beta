    ...
    public JSONObject getChartData(String uid, HttpServletRequest request) {
        ...
        if (StringUtils.isNotBlank(uid)) {
            try {
                ...
                Map<String, Object> appendQueryParameters=tableReportService.getQueryAppendParameters(request.getParameterMap(),
                        options.getDataRange());
                
                ReportDataSet reportData = tableReportService.getReportDataSet(po, formParameters,appendQueryParameters);
